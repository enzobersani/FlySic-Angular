export class CalendarDateUtilsHelper {
    ...
    public static convetToDate(date: any) {
        return typeof date == 'string' ? CalendarDateUtilsHelper.toDate(date): date;
    }

    public static toDate(date: string): Date {
        let dateFix = date.split('T')[0];
        return new Date(`${dateFix}T23:59:59.999Z`);
    }
