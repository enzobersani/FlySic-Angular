...
import { CalendarRangeService } from './base-calendar-range.service';

describe('CalendarRangeService', () => {
  let service: CalendarRangeService;

  beforeEach(() => {
    TestBed.configureTestingModule({ providers: [CalendarRangeService] });
    service = TestBed.inject(CalendarRangeService);
  });
  ...
  for (let i = 1; i <= 30; i++) {
    ...
    it('should get last two month', () => {
      ...
      // Act
      let result = service.lastTwoMonth();
    ...
    it('should get last semester', () => {
      ...
      // Act
      let result = service.lastSemester();
