...
describe('TextsService', () => {
  ...
  const idServiceSpy = jasmine.createSpyObj<IdService>(['get']);

  beforeEach(() => {
    service = new TextsService(idServiceSpy);
  });
  ...
  it('should get month by number', () => {
    ...
    // Arrange
    const textsModel = new TextsModel();
  ...
  it('should setTexts()', () => {
     // Arrange
     const textModelMock = new TextsModel();
