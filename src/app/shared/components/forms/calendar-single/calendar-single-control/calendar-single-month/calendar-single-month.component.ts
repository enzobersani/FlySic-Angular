...
@Component({
  selector: 'cso-calendar-single-month',
  templateUrl: './calendar-single-month.component.html',
  styleUrls: ['./calendar-single-month.component.scss'],
  imports: [NgClass],
  standalone: true,
})
export class CalendarSingleMonthComponent implements OnInit {
