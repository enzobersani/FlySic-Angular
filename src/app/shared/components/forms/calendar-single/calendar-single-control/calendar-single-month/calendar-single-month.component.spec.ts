...
import { CalendarSingleMonthComponent }    from './calendar-single-month.component';
...
describe('CalendarSingleMonthComponent', () => {
  let component: CalendarSingleMonthComponent;
  let fixture  : ComponentFixture<CalendarSingleMonthComponent>;
  ...
  beforeEach(() => {
    fixture   = TestBed.createComponent(CalendarSingleMonthComponent);
  ...
  describe('should checkByInitialDate()', () => {
  ...
  describe('should checkByFinalDate()', () => {
    it('when Date is null', () => {
      component.date = new Date('01/01/23');
      component.currentYear = 2023;
