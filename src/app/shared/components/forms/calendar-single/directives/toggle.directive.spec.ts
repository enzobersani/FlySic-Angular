...
import { CalendarSingleToggleDirective } from './toggle.directive';
...
describe('ToggleDirective', () => {
  ...
  it('should create an instance', () => {
    ...
    // Act
    const directive = new CalendarSingleToggleDirective(toggleService);
  ...
  it('should click out', () => {
    ...
    // Arrange
    const toggleServiceSpy    = jasmine.createSpyObj('CalendarSingleToggleService', ['close']);
    const directive           = new CalendarSingleToggleDirective(toggleServiceSpy);
  ...
  [
    ...
    it(`should open on compo [btn-close(${element.btnClose})+selected-option(${element.selectedOption})=open(${element.openCalled})]`, () => {
      ...
      // Arrange
      const toggleServiceSpy = jasmine.createSpyObj('CalendarSingleToggleService', ['open']);
      const directive        = new CalendarSingleToggleDirective(toggleServiceSpy);
