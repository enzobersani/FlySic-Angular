...
import { InputFileButtonComponentMock } from '../../../_mocks/components/input-file-button.component.mock';
import { InputFileMessageComponentMock } from '../../../_mocks/components/input-file-message.component.mock';
import { InputFileAttachmentComponentMock } from './../../../_mocks/components/input-file-attachment.component.mock';
...
describe('InputFileComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    declarations: [InputFileAttachmentComponentMock,
        InputFileButtonComponentMock,
        InputFileMessageComponentMock,],
    imports: [
        FormsModule,
        ReactiveFormsModule,
